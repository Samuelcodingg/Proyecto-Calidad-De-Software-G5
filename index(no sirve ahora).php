...
<body class="w3-theme-d5">
    <nav class="w3-top">
        ...
        <div class="w3-bar w3-theme-d5" id="mySidebar">
            ...
            <a href="login.php" class="w3-bar-item w3-button w3-hide-small"><i class="fas fa-id-badge"></i> INICIAR SESION</a>
        ...
        <div class="w3-bar-block w3-theme-d4 w3-hide w3-hide-large w3-hide-medium" id="navPeq">
            ...
            <a href="login.php" class="w3-bar-item w3-button" onclick="alternarFuncion()">INICIAR SESIÓN</a>
