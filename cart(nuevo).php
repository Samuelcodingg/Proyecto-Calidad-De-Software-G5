        ...
        <div class="row-special d-flex">
            <div class="col-sm-9">
                ...
                <div class="row-another border-top py-3 mt-3 d-flex">
                    <div class="col-sm-2">
                        <img src="image/placa-de-video.jpg" style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-size-20" style="font-size: 20px;">Placa de video</h5>
                        <small>por Intel</small>
                    ...
                    <div class="col-sm-2 text-end">
                        <div class="font-size-20 text-danger" style="font-size: 20px;">
                            S/.<span class="product_price">1099.00</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="sub-total text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-size-20" style="font-size: 20px;">Subtotal (1 producto)&nbsp;<span class="text-danger">S/.<span class="text-danger" id="deal-price">1099.00</span></span></h5>
